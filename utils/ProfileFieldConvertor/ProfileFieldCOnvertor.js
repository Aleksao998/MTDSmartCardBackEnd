...
const mobileNumberConvertor = (number, prefix) =>{
...
const homeNumberConvertor = (number,prefix) => {
...
const twitterConvertor = (profileName) => {
    if(profileName.indexOf("http://twitter.com/") == 0 || profileName.indexOf("https://twitter.com/") == 0){
        return profileName;
    }
...
const snapchatConvertor = (profileName) => {
    if(profileName.indexOf("http://snapchat.com/add/") == 0 || profileName.indexOf("https://snapchat.com/add/") == 0){
        return profileName;
    }
...
const instagramConvertor = (profileName) => {
    if(profileName.indexOf("http://instagram.com/") == 0 || profileName.indexOf("https://instagram.com/") == 0){
        return profileName;
    }
    if(profileName.indexOf("@") == 0){
        profileName=profileName.slice(1);
...
const linkedinConvertor = (profileName) => {
    ...
    if(profileName.indexOf("http") !== 0 || profileName.indexOf("www")!== 0 || profileName.indexOf("linkedin")!== 0 || profileName.indexOf("https")!== 0){
...
const number=twitterConvertor("KimKardashian");
